...
const MsgDeleteTask = `Send me task's id for deletion:`
const MsgDeleteTaskFormatErr = `Wrong task's id value, it must be integer. Please, send me task's id for deletion again:':`
